...
const token_counter_js_1 = require("../llm/token-counter.js");
/**
 * 上下文管理器
 *
 * 理解：这个类就是"聊天记录管理器"
...
class ContextManager {
    ...
    constructor(systemPrompt) {
        ...
        this.tokenCounter = new token_counter_js_1.TokenCounter();
        // 如果有系统提示词，作为第一条消息
     ...
     */
    getLastN(n, includeSystem = false) {
     ...
     */
    trimTo(maxTokens, safetyFactor = 1.2) {
        // 有效上限（留出安全余量）
